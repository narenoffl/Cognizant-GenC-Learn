...
function EstimateFixedInterestLoan() {
  ...
  const totalInterestFixed =
    (principalAmount * interestRateYear * tenureMonth) / 1200;
  const totalPaymentFixed = principalAmount + totalInterestFixed;
  const emiFixed = totalPaymentFixed / tenureMonth;

  document.getElementById("tInterestFixed").innerHTML = Number(
    totalInterestFixed
  )
    .toFixed(2)
    .toString();
  document.getElementById("tPaymentFixed").innerHTML = Number(totalPaymentFixed)
    .toFixed(2)
    .toString();
  document.getElementById("EMIFixed").innerHTML = Number(emiFixed)
    .toFixed(2)
    .toString();
}
...
function calculateEMI() {
  ...
  document.getElementById("EMI").innerHTML = Number(emiReducing)
    .toFixed(2)
    .toString();
}
...
function totalPayment() {
  ...
  document.getElementById("tPayment").innerHTML = Number(totalPaymentReducing)
    .toFixed(2)
    .toString();
}
...
function totalInterest() {
  ...
  document.getElementById("tInterest").innerText = Number(totalInterestReducing)
    .toFixed(2)
    .toString();
}
